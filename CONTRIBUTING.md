...
First off, thank you for taking the time to contribute! 🥳 propel2excel is nothing
without its community and that certainly extends to the software that we build.
This is a big team effort!

## First Things First

The #1 reason that we decided to open source engine was so that propel2excel
...
space for our community, we will only accept contributions from propel2excel
members. ❤️
...
Follow these steps in order to get started with contributing to engine!
...
7. [Configure the upstream repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/configuring-a-remote-repository-for-a-fork),
   ...
   with the engine codebase as new code is added to it in the future.

   ```
   git remote add upstream https://github.com/propel2excelorg/engine.git
   ```
...
That's it -- you've finished setting up engine locally! All your applications
...
5. Here is an [example PR](https://github.com/propel2excelorg/engine/pull/417) in
   case you want to follow one!

Boom, you're all done! This should be approved and merged soon, and you'll
officially be an engine contributor! 🥳

## Deciding What to Work On

You can start by browsing through our list of
[issues](https://github.com/propel2excelorg/engine/issues). Once you've decided on
...
[product roadmap](https://github.com/orgs/propel2excelorg/projects/4) so if
...
[`#engine`](https://propel2excel-family.slack.com/channels/C06S0DBFD6X) channel in
Slack! If the maintainers see value in the idea, they will add it to our
[product roadmap](https://github.com/orgs/propel2excelorg/projects/4) or create an
[issue](https://github.com/propel2excelorg/engine/issues) directly.

### Reporting Bugs

If you find a bug, please file a
[bug report](https://github.com/propel2excelorg/engine/issues/new?assignees=&labels=Bug+%F0%9F%90%9E&projects=&template=bug_report.md&title=)
directly!
